...
#create vehicle lane
dP11=a.DatumPointByCoordinate(coords=(0, 9.0, 0))
dP12=a.DatumPointByCoordinate(coords=(0, 9.0+2.5, 0))

dP21=a.DatumPointByCoordinate(coords=(22, 9.0, 0))
dP22=a.DatumPointByCoordinate(coords=(22, 9.0+2.5, 0))
...
f1 = a.instances['Plate-1'].faces
pickedFaces = f1.findAt(((3.666667, 9.833333, 0.0), ), ((14.666667, 10.3, 0.0), 
    ))
d11 = a.datums
...
e1 = a.instances['Plate-1'].edges
edges1 = e1.findAt(((0.0, 4.5, 0.0), ), ((0.0,10.25 , 0.0), ), ((0.0, 12.25, 
    0.0), ))
a.Set(edges=edges1, name='End-1')
...
edges1 = e1.findAt(((11.0, 4.5, 0.0), ), ((11.0, 10.25, 0.0), ), ((11.0, 
    12.25, 0.0), ))
a.Set(edges=edges1, name='End-2')
...
edges1 = e1.findAt(((22.0, 4.5, 0.0), ), ((22.0, 10.25, 0.0), ), ((22.0, 
    12.25, 0.0), ))
a.Set(edges=edges1, name='End-3')
...
#q=10.5
#rPoint=(rp21,rp22)
#tupleLoad=(-q*span*1000,-q*span*1000)
#edgeTuple=((8.25, 3.0, 0.0),(8.25, 6.5, 0.0))
...
#renqun lane2
s1 = a.instances['Plate-1'].faces
side2Faces1 = s1.findAt(((7.333333, 10.666667, 0.0), ))
region = a.Surface(side2Faces=side2Faces1, name='Surf-3')
mdb.models['FuzhouHouyuRoad'].Pressure(name='Load-1', 
    createStepName='ApplyLoad', region=region, distributionType=UNIFORM, 
    field='', magnitude=-3937.5, amplitude=UNSET)
