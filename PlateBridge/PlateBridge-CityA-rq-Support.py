...
rp14=a.ReferencePoint(point=(span+5.5, 3.0, 0.0))
rp15=a.ReferencePoint(point=(span+5.5, 6.5, 0.0))
rp16=a.ReferencePoint(point=(span+5.5, 10.0, 0.0))
...
a = mdb.models[modelName].rootAssembly
s1 = a.instances['Plate-2'].faces
side2Faces1 = s1.findAt(((7.333333, 16.0, 0.4), ))
region = a.Surface(side2Faces=side2Faces1, name='Surf-3')
mdb.models[modelName].Pressure(name='Load-1', 
    createStepName='ApplyLoad', region=region, distributionType=UNIFORM, 
    field='', magnitude=-4050.0, amplitude=UNSET)

a = mdb.models[modelName].rootAssembly
s1 = a.instances['Plate-2'].faces
side2Faces1 = s1.findAt(((14.666667, 17.0, 0.4), ))
region = a.Surface(side2Faces=side2Faces1, name='Surf-4')
mdb.models[modelName].Pressure(name='Load-2', 
    createStepName='ApplyLoad', region=region, distributionType=UNIFORM, 
    field='', magnitude=-4050.0, amplitude=UNSET)

#largeNum=50
##create cload
#rPoint=(rp11,rp12,rp13,rp14,rp15,rp16)
#tupleLoad=(-204000,-204000,-204000,-204000,-204000,-204000)
...
#mdb.models[modelName].Pressure(name='Load-7', 
#    createStepName='ApplyLoad', region=region, distributionType=UNIFORM, 
...
#mdb.models[modelName].Pressure(name='Load-8', 
#    createStepName='ApplyLoad', region=region, distributionType=UNIFORM, 
#    field='', magnitude=-3000.0, amplitude=UNSET)
...
#mdb.models[modelName].Pressure(name='Load-9', 
#    createStepName='ApplyLoad', region=region, distributionType=UNIFORM, 
#    field='', magnitude=-3000.0, amplitude=UNSET)

#a = mdb.models[modelName].rootAssembly
#s1 = a.instances['Plate-1'].faces
#side2Faces1 = s1.findAt(((span+7.333333, 3.583333, 0.0), ))
#region = a.Surface(side2Faces=side2Faces1, name='Surf-10')
#mdb.models[modelName].Pressure(name='Load-10', 
#    createStepName='ApplyLoad', region=region, distributionType=UNIFORM, 
#    field='', magnitude=-3000.0, amplitude=UNSET)

#s1 = a.instances['Plate-1'].faces
#side2Faces1 = s1.findAt(((span+7.333333, 7.083333, 0.0), ))
#region = a.Surface(side2Faces=side2Faces1, name='Surf-11')
#mdb.models[modelName].Pressure(name='Load-11', 
#    createStepName='ApplyLoad', region=region, distributionType=UNIFORM, 
#    field='', magnitude=-3000.0, amplitude=UNSET)

#s1 = a.instances['Plate-1'].faces
#side2Faces1 = s1.findAt(((span+7.988095, 10.583333, 0.0), ))
#region = a.Surface(side2Faces=side2Faces1, name='Surf-12')
#mdb.models[modelName].Pressure(name='Load-12', 
#    createStepName='ApplyLoad', region=region, distributionType=UNIFORM, 
#    field='', magnitude=-3000.0, amplitude=UNSET)
