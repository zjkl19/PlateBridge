...
mdb.models[modelName].materials[C40].Density(table=((2549.0, ), ))
...
#mdb.models[modelName].Tie(name='Constraint-13', master=region1, 
#    slave=region2, positionToleranceMethod=COMPUTED, adjust=ON, 
#    tieRotations=ON, thickness=ON)

#create mass point
#a = mdb.models[modelName].rootAssembly
r_mass1=a.ReferencePoint(point=(11.0, 7.75, 0.0))
r1 = a.referencePoints
refPoints1=(r1[r_mass1.id], )
...
mdb.models[modelName].rootAssembly.engineeringFeatures.PointMassInertia(
    name='Inertia-1', region=region1, mass=72340.62, alpha=0.0, composite=0.0)

f1 = a.instances['Plate-1'].faces
faces1 = f1.findAt(((18.333333, 8.833333, 0.0), ), ((3.666667, 10.5, 0.0), ), (
    (18.333333, 5.333333, 0.0), ), ((7.333333, 8.833333, 0.0), ), ((18.333333, 
    2.0, 0.0), ), ((7.333333, 5.333333, 0.0), ), ((7.333333, 2.0, 0.0), ), ((
    14.666667, 10.966667, 0.0), ))
region2=a.Set(faces=faces1, name='s_Set-4')
mdb.models[modelName].Coupling(name='Constraint-2', 
    controlPoint=region1, surface=region2, influenceRadius=WHOLE_SURFACE, 
    couplingType=STRUCTURAL, weightingMethod=UNIFORM, localCsys=None, u1=ON, 
    u2=ON, u3=ON, ur1=ON, ur2=ON, ur3=ON)

#rail
e1 = a.instances['Plate-2'].edges
r_mass2=a.ReferencePoint(point=a.instances['Plate-2'].InterestingPoint(edge=e1.findAt(
    coordinates=(11.0, 17.0, 0.4)), rule=MIDDLE))
r1 = a.referencePoints
refPoints1=(r1[r_mass2.id], )
region1=a.Set(referencePoints=refPoints1, name='m_Set-6')
f1 = a.instances['Plate-2'].faces
faces1 = f1.findAt(((7.333333, 16.0, 0.4), ), ((14.666667, 17.0, 0.4), ))
region2=a.Set(faces=faces1, name='s_Set-6')
mdb.models[modelName].Coupling(name='Constraint-I2', 
    controlPoint=region1, surface=region2, influenceRadius=WHOLE_SURFACE, 
    couplingType=STRUCTURAL, weightingMethod=UNIFORM, localCsys=None, u1=ON, 
    u2=ON, u3=ON, ur1=ON, ur2=ON, ur3=ON)
r1 = a.referencePoints
...
mdb.models[modelName].rootAssembly.engineeringFeatures.PointMassInertia(
    name='Inertia-2', region=region, mass=13508.0, alpha=0.0, composite=0.0)
...
mdb.models[modelName].FrequencyStep(name='Step-Freq', previous='Initial', 
    description='testFreq', maxEigen=100.0)
#maxEigen:Maximum frequency of interest(cycles/time)

mdb.models[modelName].FieldOutputRequest(name='F-Output-3', 
    createStepName='Step-Freq', variables=('ENER', 'ELEN'))

##create boundry
region = a.sets['End-1']
mdb.models[modelName].DisplacementBC(name='BC-1', createStepName='Step-Freq', 
    region=region, u1=0.0, u2=0.0, u3=0.0, ur1=0.0, ur2=UNSET, ur3=0.0, 
    amplitude=UNSET, fixed=OFF, distributionType=UNIFORM, fieldName='', 
    localCsys=None)

region = a.sets['End-2']
mdb.models[modelName].DisplacementBC(name='BC-2', createStepName='Step-Freq', 
    region=region, u1=0.0, u2=0.0, u3=0.0, ur1=0.0, ur2=UNSET, ur3=0.0, 
    amplitude=UNSET, fixed=OFF, distributionType=UNIFORM, fieldName='', 
    localCsys=None)

region = a.sets['End-3']
mdb.models[modelName].DisplacementBC(name='BC-3', createStepName='Step-Freq', 
    region=region, u1=0.0, u2=0.0, u3=0.0, ur1=0.0, ur2=UNSET, ur3=0.0, 
    amplitude=UNSET, fixed=OFF, distributionType=UNIFORM, fieldName='', 
    localCsys=None)
